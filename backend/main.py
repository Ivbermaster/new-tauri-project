...
names = [
    ...
    "Bruce", "Alice", "Gabriel", "Judy", "Joe", "Isabella", "Logan", "Julia", "Alan", "Grace",
    "Juan", "Amber", "Albert", "Denise", "Willie", "Danielle", "Elijah", "Marilyn", "Wayne", "Beverly",
    "Randy", "Charlotte", "Vincent", "Natalie", "Mason", "Theresa", "Roy", "Diana", "Ralph", "Brittany",
    "Bobby", "Doris", "Russell", "Kayla", "Bradley", "Alexis", "Philip", "Lori", "Eugene"
]
...
class Main(Resource):
    def get(self, search):
        if search == " ":
            ...
            results = [name for name in names if search in name]
            return results


api.add_resource(Main, "/api/main/<string:search>")
api.init_app(app)
